...
onBeforeRouteLeave((to) => {
            tabs3ProjectTracking.changeShowpicturelist(false) 
...
onMounted(()=>{
    ...
    watchEffect(
        () =>{
            showpicturelist.value = tabs3ProjectTracking.showpicturelist 
        }
    )  
    }, 300); 
})
            ...
            <transition name="el-zoom-in-center">
                    ...
                    <ul class="flex flex-align-center" v-show="showpicturelist">
                        ...
                        <li class="flex flex-align-center" 
                            v-for="(item, index) in tabs3ProjectTracking.list" :key="index"                      
        ...
        align-center>
          <div class="ShowPhoto">
            ...
            <div class="footerText">
                <span>{{tabs3ProjectTracking.companyName}}</span> 
            </div>
          </div>
        </el-dialog>
    </div>
